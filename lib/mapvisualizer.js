class Visualizer {
    ...
    static render(mapping, element, colors=null, already_mapped=false) {
    ...
    static randomColor() {
        ...
        return '#' + shuffle([randomHex(128,256), randomHex(0, 128), randomHex(0, 128)]).join('');
    }
}